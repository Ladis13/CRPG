...
public:
    ...
    inline int getDodge() const {
        return this->sstats[SSTAT::DODGE]; }
    inline int getLimit() const {
        return this->sstats[SSTAT::LIMIT]; }

    //Modifiers
    inline void setVitality(int n) {
        this->sstats[SSTAT::VITALITY] = n; }
    inline void setEnergy(int n) {
        this->sstats[SSTAT::ENERGY] = n; }
    inline void setTenacity(int n) {
        this->sstats[SSTAT::TENACITY] = n; }
    inline void setWill(int n) {
        this->sstats[SSTAT::WILL] = n; }
    inline void setPower(int n) {
        this->sstats[SSTAT::POWER] = n; }
    inline void setResistance(int n) {
        this->sstats[SSTAT::RESISTANCE] = n; }
    inline void setPerception(int n) {
        this->sstats[SSTAT::PERCEPTION] = n; }
    inline void setMastery(int n) {
        this->sstats[SSTAT::MASTERY] = n; }
    inline void setDodge(int n) {
        this->sstats[SSTAT::DODGE] = n; }
    inline void setLimit(int n) {
        this->sstats[SSTAT::LIMIT] = n; }
};
